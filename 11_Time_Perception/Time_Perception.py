...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\LENOVO\\Documents\\1904班黄子航\\11_Time_Perception\\Time_Perception.py',
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    sound_1.setSound('1000', secs=m, hamming=True)
    ...
    # keep track of which components have finished
    trial1Components = [text_2, image, sound_1, text_3, image_2, text_4, key_resp_2, image_5, text_15, key_resp_10]
    ...
    while continueRoutine:
        ...
        # *key_resp_2* updates
        if key_resp_2.status == NOT_STARTED and t >= s2-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *image_5* updates
        if image_5.status == NOT_STARTED and tThisFlip >= s2-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *text_15* updates
        if text_15.status == NOT_STARTED and tThisFlip >= s2-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *key_resp_10* updates
        if key_resp_10.status == NOT_STARTED and t >= s2-frameTolerance:
            # keep track of start time/frame for later
    ...
    trials.addData('key_resp_2.started', key_resp_2.tStart)
    trials.addData('key_resp_2.stopped', key_resp_2.tStop)
    ...
    trials.addData('key_resp_10.started', key_resp_10.tStart)
    trials.addData('key_resp_10.stopped', key_resp_10.tStop)
...
for thisTrial_2 in trials_2:
    ...
    _key_resp_9_allKeys = []
    # keep track of which components have finished
    trial2Components = [text_11, image_3, text_12, image_4, text_13, key_resp_9]
    ...
    while continueRoutine:
        ...
        # *key_resp_9* updates
        if key_resp_9.status == NOT_STARTED and t >= s2-frameTolerance:
            # keep track of start time/frame for later
        ...
        if key_resp_9.status == STARTED:
            ...
            if len(_key_resp_9_allKeys):
                ...
                # was this correct?
                if (key_resp_9.keys == str(j)) or (key_resp_9.keys == j):
                    key_resp_9.corr = 1
                else:
                    key_resp_9.corr = 0
    ...
    trials_2.addData('key_resp_9.started', key_resp_9.tStart)
    trials_2.addData('key_resp_9.stopped', key_resp_9.tStop)

...
expName = 'Facial Emotion Recognition'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\LENOVO\\Desktop\\1904班黄子航\\Facial_Emotion_Recognition\\Facial_Emotion_Recognition_Formal.py',
...
for thisTrial in trials:
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    trial1Components = [text_4, image, text_2, key_resp_2]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *key_resp_2* updates
        waitOnFlip = False
        if key_resp_2.status == NOT_STARTED and tThisFlip >= 1.75-frameTolerance:
            # keep track of start time/frame for later
        ...
        if key_resp_2.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_2_allKeys):
                ...
                # was this correct?
                if (key_resp_2.keys == str(j)) or (key_resp_2.keys == j):
                    key_resp_2.corr = 1
                else:
                    key_resp_2.corr = 0
                # a response ends the routine
...
_key_resp_4_allKeys = []
# keep track of which components have finished
breakingComponents = [text_7, key_resp_4]
...
for thisTrial_2 in trials_2:
    ...
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    trial2Components = [text_5, image_2, text_6, key_resp_3]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if key_resp_3.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_3_allKeys):
                ...
                # was this correct?
                if (key_resp_3.keys == str(j)) or (key_resp_3.keys == j):
                    key_resp_3.corr = 1
                else:
                    key_resp_3.corr = 0
                # a response ends the routine

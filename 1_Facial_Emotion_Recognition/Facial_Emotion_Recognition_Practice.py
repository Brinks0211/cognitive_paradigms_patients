...
expName = 'Facial'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\LENOVO\\Desktop\\1904班黄子航\\Facial_Emotion_Recognition\\Facial_Emotion_Recognition_Practice.py',
...
expName = 'Facial_Emotion_Recognition_Practice'
...
for thisTrial in trials:
    ...
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    trialComponents = [text_4, image, text_5, key_resp_4]
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if key_resp_4.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_4.getKeys(keyList=['1', '2', '3', '4', '5', '6'], waitRelease=False)
            _key_resp_4_allKeys.extend(theseKeys)
            if len(_key_resp_4_allKeys):
                key_resp_4.keys = _key_resp_4_allKeys[-1].name  # just the last key pressed
                key_resp_4.rt = _key_resp_4_allKeys[-1].rt
                # was this correct?
                if (key_resp_4.keys == str(j)) or (key_resp_4.keys == j):
                    key_resp_4.corr = 1
                else:
                    key_resp_4.corr = 0
                # a response ends the routine
